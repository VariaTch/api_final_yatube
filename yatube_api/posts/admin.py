...
class PostInline(admin.TabularInline):
    ...
    Используется для отображения списка постов внутри страницы редактирования группы.
    """
    model = Post
    extra = 1
...
class CommentInline(admin.TabularInline):
    ...
    Используется для отображения списка комментариев внутри страницы редактирования поста.
    """
    model = Comment
    extra = 1
...
class GroupAdmin(admin.ModelAdmin):
    ...
    Включает отображение полей, настройку поиска и возможность добавления постов.
    """
    list_display = (
        "pk",
        "title",
...
class PostAdmin(admin.ModelAdmin):
    ...
    Включает отображение полей, фильтрацию по дате, автору и группе, а также возможность добавления комментариев.
    """
    list_display = (
        "pk",
        "short_text",
...
class FollowAdmin(admin.ModelAdmin):
    ...
    Включает отображение полей, фильтрацию по пользователю и подписанному пользователю.
    """
    list_display = (
        "pk",
        "user",
